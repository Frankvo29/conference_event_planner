...
const ConferenceEvent = () => {
  ...
  /* use disabled in button to avoid the need of creating this const
  ...
  const handleMealSelection = (index) => {
    ...
    if (item.type === "mealForPeople") {
      const updatedNumberOfPeople = item.selected ? 0 : numberOfPeople;
        ...
        {!showItems ? (
          <div className="items-information">
                      ...
                      "Auditorium Hall (Capacity:200)" ? (
                        <>
                          ...
                          <button
                            ...
                            disabled={venueItems[index].quantity === 3}
                          >
                            &#43;
                          </button>
                        </>
            ...
            <div id="addons" className="venue_container container_main">
              ...
              <div className="total_cost">Add-ons Cost: ${addonTotalCost}</div>
            </div>
            ...
            <div id="meals" className="venue_container container_main">
              ...
              <div className="input-container venue_selection">
                ...
                <div className="meal_selection">
                  {mealsItems.map((item, index) => (
                    <div className="meal_item" key={index} style={{padding: 16}}>
                      <div className="inner">
              ...
              <div className="total_cost">Meals Cost: ${mealsTotalCost} </div>
            </div>
          </div>
        ) : (
